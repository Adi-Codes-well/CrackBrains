...
const ProductDetails = () => {
  ...
  const [userData, setUserData] = useState(null); // To store current user info
  ...
  // --- RENDER LOGIC ---
  if (loading) return <div className="flex items-center justify-center h-screen">Loading product details...</div>;
  if (error) return <div className="flex items-center justify-center h-screen text-red-500">{error}</div>;
  if (!product) return <div className="flex items-center justify-center h-screen">Product data could not be loaded.</div>;
