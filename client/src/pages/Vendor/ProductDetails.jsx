  ...
  useEffect(() => {
    ...
    const fetchProductAndReviews = async () => {
      ...
      try {
        ...
        const productRes = await axios.get(`${import.meta.env.VITE_APP_API_URL}/api/products/${id}`);
        ...
        const reviewsRes = await axios.get(`${import.meta.env.VITE_APP_API_URL}/api/reviews/product/${id}`);
    ...
    <div className="min-h-screen bg-gray-50">
        <div className="bg-white shadow-sm border-b border-gray-200 p-4 sticky top-0 z-10">
            <div className="max-w-7xl mx-auto">
                <a href="/browse"><Link to="/browse" className="flex items-center text-gray-600 hover:text-gray-900 font-medium">
